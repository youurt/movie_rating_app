    ...
    <v-flex xs4>
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2016 ‧ Science fiction film/Action fiction ‧ 3h 3m</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text">
          ...
          The loss of life and collateral damage left many feeling angry and
        ...
        <v-card-actions>
          <v-btn flat color="grey">Rate this movie</v-btn>
          <v-spacer></v-spacer>
        </v-card-actions>
      </v-card>
    </v-flex>
      ...
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2017 ‧ Drama/Science fiction film ‧ 2h 21m</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text">
          ...
          border. a young protect His plan to hide from the outside world gets
          upended when he meets mutant (Dafne Keen) who is very much like him.
          Logan must now the girl and battle the dark forces that want to
          capture her.
        </v-card-text>
        <v-card-actions>
          <v-btn flat color="grey">Rate this movie</v-btn>
      ...
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2017 ‧ Fantasy/Science fiction film ‧ 2h 35m</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text">
          Luke Skywalker's peaceful and solitary existence gets upended when he
          encounters Rey, a young woman who shows strong signs of the Force. Her
          desire to learn the ways of the Jedi forces Luke to make a decision
          that changes their lives forever. Meanwhile, Kylo Ren and General Hux
          lead the First Order in an all-out assault against Leia and the
          Resistance for supremacy of the galaxy.
        </v-card-text>
        <v-card-actions>
          <v-btn flat color="grey">Rate this movie</v-btn>
          <v-spacer></v-spacer>
      ...
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2017 ‧ Fantasy/Science fiction film ‧ 2h 21m</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text">
          ...
          world. Convinced that she can stop the threat, Diana leaves her home
          for the first time. Fighting alongside men in a war to end all wars,
      ...
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2017 ‧ Drama/Thriller ‧ 2 hours</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text">
      ...
      <v-card class="card">
        <v-card-title primary-title class ="card__title--primary">
          <div>
            ...
            <span class="grey--text"
              >2015 ‧ Drama/Thriller ‧ 2h 36m</span
            >
          </div>
        </v-card-title>
        <v-card-text class="card__text"> 
